   ...
   const myChart = new Chart(document.getElementById('myChart').getContext('2d'), {
      ...
      data: {
         ...
         datasets: [
            ...
            {
               label: 'Media Giorno Precedente',
               data: array.avgCloses,
...
let array = {
   stocks: [], dates: [], prices: [], avgs: [], avgCloses: []
};
...
document.querySelector('#stocks').addEventListener('change', function() {
   ...
   let sumCloses = 0, avgClose = array.stocks[0].close;
   ...
   array.stocks.forEach((el,i) => {
      ...
      avgClose = (avgClose + el.close) / 2;
      array.avgCloses.push(avgClose);
